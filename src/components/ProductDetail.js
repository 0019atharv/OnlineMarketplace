...
function ProductDetail() {
  ...
  useEffect(() => {
      socket = io('https://onlinemarketplace-backend.onrender.com/')
  ...
  useEffect(() => {
    const url = "https://onlinemarketplace-backend.onrender.com/getproduct/" + p.productId;
    axios.get(url)
        .then((res) => {
            if (res.data.product) {
...
const handleSend = () => {
  ...
  const handleContact = (addedBy) => {
    ...
    const url = "https://onlinemarketplace-backend.onrender.com/getuser/" + addedBy;
    axios
      .get(url)
      .then((res) => {
        console.log(res);
