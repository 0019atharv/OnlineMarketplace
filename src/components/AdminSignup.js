...
function AdminSignup(){
    ...
    const handleApi = () => {
        ...
        const url = "https://onlinemarketplace-backend.onrender.com/adminsignup"
    ...
    return(
      ...
      <div className ="name-content" style={{'width': '400px'}}>
        ...
        <button className="login" type="button" onClick={handleApi}>Create New Account</button>
          <hr />
          <button className="create-account" type="button" onClick={() => navigate('/adminlogin')}>Login</button>
        </form>
      </div>
    </div>
    )
